...
smallDogList = ['포메라니안','치와와','미니어처 핀셔','파피용','토이 푸들','미니어처 닥스훈트','요크셔 테리어','말티즈','비숑 프리제','미니어처 슈나우저','페키니즈','꼬똥 드 툴레아','재퍼니스 친', '아펜핀셔', '토이 폭스테리어', '브리셀 그리펀', '볼로네즈', '믹스']
middleDogList = ['퍼그','웰시코기','프렌치 불도그','비글','코카 스파니엘','보스턴 테리어','셔틀랜드 쉽독','이탈리안 그레이하운드','스코티시 테리어','믹스']
bigDogList = ['사모예드','셰퍼드','세인트버나드','차우차우','그레이트 데인','라브라도어','허스키','골든리트리버','믹스']
def setBreedTable() :
    b_list = []
